...
{ DEPRECATED - these forms are now auto-created on program start-up
...
{*** Modified 7/3/07 ***}
{ IniLoadToolbarPositions(self, IniFileDir+INIFILE);  DEPRECATED  }
...
//----------------------------------------------------------------
//var
{ OldBoldFonts: Boolean;  DEPRECATED  }
begin
{ OldBoldFonts := BoldFonts;  DEPRECATED  }
